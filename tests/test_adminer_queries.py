...
ADMINER_QUERIES = {
    ...
    "preparation_request_nodes": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['azure_set_gag', 'graph_rbcd', 'objects_to_domain_admin', 'set_containsda', 'set_containsdc', 'set_da', 'set_da_types', 'set_dac_types', 'set_dag', 'set_dag_types', 'set_dagg', 'set_dagg_types', 'set_daggg', 'set_dc', 'set_dcg', 'set_dcsync1', 'set_dcsync2', 'set_ghost_computer', 'set_gpo_links_count', 'set_gpos_has_links', 'set_groups_direct_admin', 'set_groups_has_members', 'set_groups_indirect_admin_1', 'set_groups_indirect_admin_2', 'set_groups_indirect_admin_3', 'set_groups_indirect_admin_4', 'set_groups_members_count', 'set_groups_members_count_computers', 'set_is_adcs', 'set_is_adminsdholder', 'set_is_da_dc', 'set_is_dnsadmin', 'set_is_group_operator', 'set_is_not_da_dc', 'set_is_operator_member', 'set_msol', 'set_non_server', 'set_nonda', 'set_nondag', 'set_nondc', 'set_nondcg', 'set_ou_candidate', 'set_path_candidate', 'set_server', 'set_target_kud', 'set_user_indirect_admin', 'set_users_direct_admin'],
    },
    "delete_unresolved": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_domain_attributes_to_domains', 'set_upper_domain_name'],
    },
    ...
    "check_if_all_domain_objects_exist": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['check_if_all_group_objects_have_domain_attribute', 'set_domain_attributes_to_domains', 'set_upper_domain_name'],
    },
    ...
    "set_is_operator_member": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_dag', 'set_dagg', 'set_domain_attributes_to_domains', 'set_msol', 'set_nonda', 'set_upper_domain_name'],
    },
    "set_dcsync1": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_dag', 'set_dagg', 'set_dc', 'set_domain_attributes_to_domains', 'set_msol', 'set_nonda', 'set_nondc', 'set_upper_domain_name'],
    },
    "set_dcsync2": {
    ...
    "set_ou_candidate": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'set_da', 'set_dag', 'set_dagg', 'set_dc', 'set_msol', 'set_nonda', 'set_nondc'],
    },
    "set_containsda": {
    ...
    "set_groups_indirect_admin_2": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['set_groups_direct_admin', 'set_groups_indirect_admin_1', 'set_groups_indirect_admin_3', 'set_groups_indirect_admin_4', 'set_user_indirect_admin', 'set_users_direct_admin'],
    },
    "set_groups_indirect_admin_3": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['set_groups_direct_admin', 'set_groups_indirect_admin_1', 'set_groups_indirect_admin_2', 'set_groups_indirect_admin_4', 'set_user_indirect_admin', 'set_users_direct_admin'],
    },
    "set_groups_indirect_admin_4": {
        ...
        "is_write": True,
        "is_gds": False,
        "depends_on": ['set_groups_direct_admin', 'set_groups_indirect_admin_1', 'set_groups_indirect_admin_2', 'set_groups_indirect_admin_3', 'set_user_indirect_admin', 'set_users_direct_admin'],
    },
    ...
    "nb_domain_controllers": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_domain_attributes_to_domains', 'set_ghost_computer', 'set_upper_domain_name'],
    },
    "domain_OUs": {
    ...
    "users_shadow_credentials_to_non_admins": {
        ...
        "depends_on": ['set_da', 'set_dag', 'set_dagg', 'set_daggg', 'set_is_group_operator', 'set_msol', 'set_nonda', 'set_nondag'],
    },
    "nb_enabled_accounts": {
    ...
    "nb_groups": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_dag', 'set_dagg', 'set_domain_attributes_to_domains', 'set_msol', 'set_nonda', 'set_upper_domain_name'],
    },
    "nb_computers": {
    ...
    "nb_domain_admins": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_da_types', 'set_dac_types', 'set_dag', 'set_dag_types', 'set_dagg', 'set_dagg_types', 'set_domain_attributes_to_domains', 'set_msol', 'set_nonda', 'set_upper_domain_name'],
    },
    "os": {
        "name": 'Number of OS',
    ...
    "anomaly_acl_1": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_dag', 'set_dagg', 'set_dc', 'set_domain_attributes_to_domains', 'set_is_adcs', 'set_msol', 'set_nonda', 'set_nondc', 'set_upper_domain_name'],
    },
    "anomaly_acl_2": {
        "name": 'anomaly_acl_2',
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_da', 'set_dag', 'set_dagg', 'set_dcg', 'set_domain_attributes_to_domains', 'set_groups_members_count', 'set_groups_members_count_computers', 'set_is_adcs', 'set_msol', 'set_nonda', 'set_nondcg', 'set_upper_domain_name'],
    },
    "get_empty_groups": {
    ...
    "cross_domain_local_admins": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['check_if_all_group_objects_have_domain_attribute', 'set_domain_attributes_to_domains', 'set_ghost_computer', 'set_upper_domain_name'],
    },
    ...
    "smb_signing": {
        ...
        "is_write": False,
        "is_gds": False,
        "depends_on": ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_dc', 'set_domain_attributes_to_domains', 'set_non_server', 'set_nondc', 'set_server', 'set_upper_domain_name'],
    },
...
PHASE_1_SET_QUERIES = ['azure_set_apps_name', 'check_if_all_group_objects_have_domain_attribute', 'set_upper_domain_name', 'set_domain_attributes_to_domains', 'check_if_all_group_objects_have_domain_attribute', 'set_upper_domain_name', 'set_server', 'set_non_server', 'set_dc', 'set_nondc', 'set_dcg', 'set_nondcg', 'set_isacl_adcs', 'set_is_adminsdholder', 'set_is_dnsadmin', 'set_da', 'set_msol', 'set_da_types', 'set_dag', 'set_dag_types', 'set_dagg', 'set_dagg_types', 'set_daggg', 'set_dac', 'set_dac_types', 'set_nonda', 'set_nondag', 'set_is_group_operator', 'set_is_operator_member', 'set_dcsync1', 'set_dcsync2', 'set_ou_candidate', 'set_containsda', 'set_containsdc', 'set_is_da_dc', 'set_is_not_da_dc', 'set_is_adcs', 'set_path_candidate', 'set_groups_members_count', 'set_groups_members_count_computers', 'set_groups_has_members', 'set_gpo_links_count', 'set_gpos_has_links', 'set_groups_direct_admin', 'set_groups_indirect_admin_1', 'set_groups_indirect_admin_2', 'set_groups_indirect_admin_3', 'set_user_indirect_admin', 'set_users_direct_admin', 'set_groups_indirect_admin_4', 'set_groups_indirect_admin_3', 'set_groups_indirect_admin_2', 'set_target_kud', 'set_az_privileged', 'set_az_not_privileged', 'set_ghost_computer', 'set_default_exploitability_rating', 'objects_to_domain_admin', 'graph_rbcd', 'compromise_paths_of_OUs', 'azure_set_gag']

PHASE_2_READ_QUERIES = ['check_relation_types', 'check_if_all_domain_objects_exist', 'onpremid_ompremsesecurityidentifier', 'set_can_extract_dc_secrets', 'set_can_load_code', 'set_can_logon_dc', 'dcsync_list', 'nb_domain_collected', 'get_all_nodes', 'check_unknown_relations', 'domains', 'nb_domain_controllers', 'domain_OUs', 'users_shadow_credentials', 'nb_enabled_accounts', 'nb_disabled_accounts', 'nb_groups', 'nb_computers', 'computers_not_connected_since', 'nb_domain_admins', 'os', 'krb_pwd_last_change', 'nb_kerberoastable_accounts', 'nb_as-rep_roastable_accounts', 'nb_computer_unconstrained_delegations', 'nb_users_unconstrained_delegations', 'users_constrained_delegations', 'dormant_accounts', 'password_last_change', 'nb_user_password_cleartext', 'get_users_password_not_required', 'objects_admincount', 'user_password_never_expires', 'computers_members_high_privilege', 'objects_to_adcs', 'users_admin_on_computers', 'users_admin_on_servers_1', 'users_admin_on_servers_2', 'computers_admin_on_computers', 'domain_map_trust', 'nb_computers_laps', 'can_read_laps', 'dom_admin_on_non_dc', 'rdp_access', 'dc_impersonation', 'graph_rbcd_to_da', 'vuln_functional_level', 'vuln_sidhistory_dangerous', 'can_read_gmsapassword_of_adm', 'objects_to_operators_groups', 'da_to_da', 'anomaly_acl_1', 'anomaly_acl_2', 'get_empty_groups', 'get_empty_ous', 'has_sid_history', 'unpriv_users_to_GPO_user_enforced', 'unpriv_users_to_GPO_user_not_enforced', 'unpriv_users_to_GPO_computer_enforced', 'unpriv_users_to_GPO_computer_not_enforced', 'unpriv_users_to_GPO', 'cross_domain_local_admins', 'cross_domain_domain_admins', 'primaryGroupID_lower_than_1000', 'pre_windows_2000_compatible_access_group', 'guest_accounts', 'unpriviledged_users_with_admincount', 'get_fgpp', 'esc15_adcs_privilege_escalation', 'smb_signing', 'ldap_server_configuration', 'azure_user', 'azure_admin', 'azure_groups', 'azure_vm', 'azure_apps', 'azure_devices', 'azure_ms_graph_controllers', 'azure_aadconnect_users', 'azure_admin_on_prem', 'azure_role_listing', 'azure_role_paths', 'azure_reset_passwd', 'azure_last_passwd_change', 'azure_dormant_accounts', 'azure_accounts_disabled_on_prem', 'azure_accounts_not_found_on_prem', 'azure_tenants', 'azure_ga_to_ga', 'azure_cross_ga_da']

GDS_QUERIES = ['users_shadow_credentials_to_non_admins', 'objects_to_domain_admin', 'kud', 'objects_to_dcsync', 'unpriv_to_dnsadmins', 'compromise_paths_of_OUs', 'vulnerable_OU_impact', 'objects_to_operators_member', 'vuln_permissions_adminsdholder', 'unpriv_users_to_GPO_init', 'azure_users_paths_high_target']
...
def bloodhound_graph():
    ...
    users = pd.DataFrame({
        "objectid": [
            "S-1-5-21-1234-500", "S-1-5-21-1234-1001",
            "S-1-5-21-1234-1002", "S-1-5-21-1234-1003",
        ],
        "name": [
            "ADMIN@TESTLAB.LOCAL", "JDOE@TESTLAB.LOCAL",
            "SVCACCT@TESTLAB.LOCAL", "DISABLED@TESTLAB.LOCAL",
        ],
    ...
    groups = pd.DataFrame({
        "objectid": [
            "S-1-5-21-1234-512", "S-1-5-21-1234-516", "S-1-5-21-1234-519",
            "S-1-5-21-1234-551", "S-1-5-21-1234-549", "S-1-5-21-1234-550",
            "S-1-5-21-1234-548", "S-1-5-21-1234-1101", "S-1-5-21-1234-518",
        ],
        "name": [
            "DOMAIN ADMINS@TESTLAB.LOCAL", "DOMAIN CONTROLLERS@TESTLAB.LOCAL",
            "ENTERPRISE ADMINS@TESTLAB.LOCAL", "BACKUP OPERATORS@TESTLAB.LOCAL",
            "SERVER OPERATORS@TESTLAB.LOCAL", "PRINT OPERATORS@TESTLAB.LOCAL",
            "ACCOUNT OPERATORS@TESTLAB.LOCAL", "DNSADMINS@TESTLAB.LOCAL",
...
class TestAdMinerGDSQueries:
    ...
    @pytest.mark.parametrize(
        "query_key",
        [pytest.param(k, id=k, marks=pytest.mark.skip(reason="GDS not supported"))
         for k in GDS_QUERIES],
    )
    def test_exec(self, query_key, bloodhound_graph):
        query = substitute_adminer_templates(ADMINER_QUERIES[query_key]["request"])
        bloodhound_graph.cypher(query)
